...
$appt = query_select_from_eq('appointments',array('1'),sprintf("appointment_id=%s and doctor_id=%s and status='paid'", $params['a'], $user_id));
if(count($appt) == 0){
...
create_email_for_appt( $user_id, 'approved', $params['a'] );
